...
async function main() {
  ...
  const ContractFactory = await hre.ethers.getContractFactory("LumberjacksDAOAttestations");
  ...
  configs.contracts.attestations = contract.address
  configs.arguments.attestations = [configs.owner_address]
